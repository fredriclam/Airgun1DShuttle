...
[solution_leak_rr0, metadata_leak_rr0] = airgunShuttleDeploy(nx, true, ...
    struct(...
        ...
        'bubbleModel', ...
            struct('type', 'single', 'waterProperties', struct(), 'flowreductionfactor', 0.2), ...
    'extraOptions', struct('TInitial', 288, 'R',0.3, 'Rdot', 1.0, 'pb', 2*198000), ...
    'leakTime', 0.0));
[solution_leak_rr1, metadata_leak_rr1] = airgunShuttleDeploy(nx, true, ...
    struct(...
        ...
        'bubbleModel', ...
            struct('type', 'single', 'waterProperties', struct(), 'flowreductionfactor', 0.2), ...
    'extraOptions', struct('TInitial', 288, 'R',0.3, 'Rdot', 1.0, 'pb', 5*198000), ...
    'leakTime', 0.0));
[solution_leak_rr2, metadata_leak_rr2] = airgunShuttleDeploy(nx, true, ...
    struct(...
        ...
        'bubbleModel', ...
            struct('type', 'single', 'waterProperties', struct(), 'flowreductionfactor', 0.2), ...
    'extraOptions', struct('TInitial', 288, 'R',0.3, 'Rdot', 1.0, 'pb', 10*198000), ...
    'leakTime', 0.0));
[solution_leak_rr3, metadata_leak_rr3] = airgunShuttleDeploy(nx, true, ...
    struct(...
        ...
        'bubbleModel', ...
            struct('type', 'single', 'waterProperties', struct(), 'flowreductionfactor', 0.2), ...
    'extraOptions', struct('TInitial', 288, 'R',0.3, 'Rdot', 10.0, 'pb', 5*198000), ...
    'leakTime', 0.0));
